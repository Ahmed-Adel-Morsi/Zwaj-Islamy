...
const filters = [
  ...
  },
  {
    ...
    name: "لون البشرة",
    options: [
      { value: "داكن", label: "داكن" },
      { value: "فاتح", label: "فاتح" },
      { value: "عنابي", label: "عنابي" },
      { value: "قمحي", label: "قمحي" },
      { value: "أشقر", label: "أشقر" },
      { value: "أسمر", label: "أسمر" },
      { value: "أبيض / ناصع البياض", label: "أبيض / ناصع البياض" },
    ],
  },
  {
    id: "hasChildren",
  ...
  },
  {
    ...
    name: "مؤهل العروسه",
    options: [
      { value: "دكتور", label: "دكتورة" },
      { value: "مهندس", label: "مهندسة" },
      { value: "معلم", label: "معلمة" },
      { value: "مؤهل عالي", label: "مؤهل عالي" },
      { value: "خريج", label: "خريجة" },
      { value: "دبلوم", label: "دبلوم" },
...
function MenForms() {
  ...
  const applyFilters = () => {
    let filtered = menFormData.filter((form) =>
  ...
  useEffect(() => {
    document.title = "إستمارات الرجال";
