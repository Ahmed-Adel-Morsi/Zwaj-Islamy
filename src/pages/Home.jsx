        ...
        <div className="lg:w-2/3 flex-center">
          <div className="grow text-center lg:text-start">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center lg:justify-start">
              ...
              <Link
                to={ROUTES.FORMS}
                className="flex-center border border-main text-main hover:bg-black/5 rounded-lg px-5 py-3 font-semibold text-lg transition"
              >
                إستمارات الزواج
                <svg
          ...
          <div>
            ...
            <div className="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
              <a
                ...
                target="_blank"
                className="w-full sm:w-auto bg-white hover:bg-opacity-90 text-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700"
              >
                <svg
                  className="me-3 size-7"
                  aria-hidden="true"
                  focusable="false"
                  data-prefix="fab"
                  data-icon="apple"
                ...
                <div className="text-center">
                  <div className="mb-1 text-xs">تحميل من خلال</div>
