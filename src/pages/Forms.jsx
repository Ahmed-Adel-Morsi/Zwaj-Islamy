...
function Forms() {
  return (
    <div className="container mx-auto px-6 py-12 sm:py-16 lg:px-8 flex-grow flex flex-col justify-evenly">
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-2xl xs:text-3xl sm:text-6xl font-bold tracking-tight text-gray-900 mb-2 xs:mb-4 sm:mb-6">
          الإستمارات
        </h2>
        <p className="xs:text-lg sm:text-xl leading-8 text-gray-600">
          يرجى إختيار نوع الإستمارة المراد البحث عنها.
        </p>
      </div>
      <div className="flex flex-col sm:flex-row justify-center gap-5 sm:gap-10 mt-10 ">
        <Link
          to="men"
