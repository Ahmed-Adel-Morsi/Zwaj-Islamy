...
function MasterSection() {
  ...
  return (
    <div className="w-full md:w-[22rem] h-full shrink-0 md:sticky md:top-10 md:right-0">
      <Section className="h-full">
        <Image />
        <div className="text-center my-6">
          <h3 className="text-[8vw] xs:text-3xl font-bold">الآنسة س</h3>
...
function RemoveForm() {
  ...
  return (
    <>
      <button
        type="button"
        className="p-3 xs:p-4 rounded-lg font-bold text-white bg-red-700 hover:bg-red-800 flex-center gap-2 mx-auto text-[4.5vw] xs:text-sm tracking-wide"
        onClick={() => setOpen(true)}
      >
        ...
        <div className="grow w-full grid lg:grid-cols-2 gap-8">
          <div className="space-y-8">
            ...
            <Section title="المواصفات المطلوبة في العريس">
              <ul className="space-y-3 text-gray-800 list-disc list-inside [&_li::marker]:text-red-700 text-[4.5vw] xs:text-base">
                <li>
                  <span className="font-bold">السن :</span> من 25 إلي 30 سنة
                </li>
                <li>
