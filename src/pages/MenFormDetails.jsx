  ...
  return (
    <div className="w-full md:w-[22rem] h-full shrink-0 md:sticky md:top-28 md:right-0">
      <Section className="h-full">
        ...
        <MainSpecifcations formData={formData} forMen />
      </Section>
    </div>
  );
}
            ...
            <div className="space-y-8">
              <Section title="مواصفات العريس">
                <ul className="space-y-3 text-gray-800 list-disc list-inside [&_li::marker]:text-red-700 text-[4.5vw] xs:text-base">
                  ...
                  />
                  <ListItem title="السكن" value={formData.housing} />
                  <ListItem title="المنطقة" value={formData.region} />
                </ul>
              </Section>
              ...
              <Section title="المواصفات المطلوبة في العروسة">
                <ul className="space-y-3 text-gray-800 list-disc list-inside [&_li::marker]:text-red-700 text-[4.5vw] xs:text-base">
                  <ListItem
                    title="السن"
                    value={`من ${formData.brideAgeRange.from} الى ${formData.brideAgeRange.to} سنة`}
                  />
                  <ListItem
                    title="المؤهل"
                  ...
                  <ListItem
                    ...
                    value={formData.brideMaritalStatus.join(" أو ")}
                  />
                  <ListItem
                    title="الأطفال"
                    value={formData.brideChildren.join(" أو ")}
                  />
                </ul>
              </Section>
            </div>
